...
sub new {
    ...
    # save column filters
    $Self->{PrefKeyColumnFilters}         = 'UserDashboardTicketGenericDynamicFieldColumnFilters' . $Self->{Name};
    $Self->{PrefKeyColumnFiltersRealKeys} = 'UserDashboardTicketGenericDynamicFieldColumnFiltersRealKeys' . $Self->{Name};
    ...
    my $PreferencesKey = 'UserDashboardTicketGenericDynamicFieldFilter' . $Self->{Name};
...
# ---
        ...
        if ( $DynamicFieldName && $ShowDynamicField ) {
            ...
            if ( IsHashRefWithData($DynamicFieldConfig) ) {
                ...
                my $DynamicFieldField = $BackendObject->EditFieldRender(
                    DynamicFieldConfig => $DynamicFieldConfig,
                    Value              => $Value,
                    LayoutObject       => $LayoutObject,
